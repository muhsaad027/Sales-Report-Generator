...
namespace grandee_project
{
    class CLsPrint
    {
        ...
        public   CLsPrint(DataGridView gridview, string ReportHeader,string title,string bankacc,string date,string incv)
        {
            _printDocument.PrintPage += new PrintPageEventHandler(_printDocument_PrintPage);
            _printDocument.BeginPrint += new PrintEventHandler(_printDocument_BeginPrint);
            gw = gridview;
            _ReportHeader = ReportHeader;
            _PersonName = "M.S Food & Dairies";
            _Account = "Title";
            _title = title;
            _Bank = "Accounts";
            _bankacc = bankacc;
        ...
        private void _printDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int iTmpWidth = 0;
            Bitmap b = new Bitmap(Properties.Resources.saad);
            ...
            while (iRow <= gw.Rows.Count - 1)
            {
                ...
                else
                {
                    ...
                    {
                        //Draw Header
                        e.Graphics.DrawString(_ReportHeader + "     :     " + _PersonName+"\n"+_Bank + "     :     "+_bankacc,
                            new Font(gw.Font, FontStyle.Bold),
                            Brushes.Black, e.MarginBounds.Left,
                            e.MarginBounds.Top +60 - e.Graphics.MeasureString(_ReportHeader ,
                            new Font(gw.Font, FontStyle.Bold),
                        ...
                        //Draw Date
                        e.Graphics.DrawImage(b,e.MarginBounds.Width/2,e.MarginBounds.Top - 60,175,50);
                        e.Graphics.DrawString("Date  :  " + strDate + "\nInvoice Number  :  " + _invoicenumber + "\n" + _Account + "  :  " + _title,
                            new Font(gw.Font, FontStyle.Bold), Brushes.Black,
                            e.MarginBounds.Left +
                            (e.MarginBounds.Width - 150 - e.Graphics.MeasureString(strDate,
                            new Font(gw.Font, FontStyle.Bold),
                        ...
                        //Draw Columns                 
                        iTopMargin = e.MarginBounds.Top +120;
                       ...
                       int colcount = 0;
                        ...
                        //}
                        for(int i= gw.Columns.Count-1;i>=0;i--)
                        {
                            _GridCol[colcount++] = gw.Columns[i];
                        }
                    ...
                    {
                        _GridCell[cellcount++] = GridRow.Cells[i];
                    }
